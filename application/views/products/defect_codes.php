<div class="page-content">
    ...
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Manage Defect Codes</li>
        </ol>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Defect Codes(<?php echo "Total Records - ".$row_count; ?>)
                    </div>
                    <div class="actions">
                        <a class="button normals btn-circle" href="<?php echo base_url()."products/add_defect_code"; ?>">
                            <i class="fa fa-plus"></i> Add New Defect Code
                        </a>
                    </div>
                </div>
                <div class="portlet-body">
                    <?php if(empty($defect_codes)) { ?>
                        <p class="text-center">No Defect List Found.</p>
                    <?php } else { ?>
                        <table class="table table-hover table-light">
                            ...
                            <tbody>
                                <?php foreach($defect_codes as $defect_code) { ?>
                                    <tr>
                                        <td><?php echo $defect_code['product_name']; ?></td>
                                        <td><?php echo $defect_code['line_name']; ?></td>
                                        <td><?php echo $defect_code['stage_no']; ?></td>
                                        <td><?php echo $defect_code['stage_name']; ?></td>
                                        <td><?php echo $defect_code['inspection_type']; ?></td>
                                        <td><?php echo $defect_code['checkpoint']; ?></td>
                                        <td><?php echo $defect_code['defect']; ?></td>
                                        <td><?php echo $defect_code['switch_code']; ?></td>
                                        <td><?php echo $defect_code['section_leader']; ?></td>
                                        <td nowrap>
                                            <a class="button small gray" 
                                                href="<?php echo base_url()."products/add_defect_code/".$defect_code['id'];?>">
